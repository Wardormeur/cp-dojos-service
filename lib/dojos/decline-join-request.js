...
function cmd_decline_join_request (args, done) {
  var seneca = this;
  var plugin = args.role;
  if (!args.user) return done(new Error('Missing parameter for cmd_decline_join_request'));
...
module.exports = cmd_decline_join_request;
